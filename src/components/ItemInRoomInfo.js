        ...
        return(
            <View style ={styles.container}>
                ...
                <View style ={{flex: 8, alignItems: 'flex-start', justifyContent: 'center'}}>
                    <Text style ={styles.decription}>Room ID: {this.props.roomID}</Text>
                    <Text style ={styles.decription}>Device: {this.props.type} {this.props.id}</Text>
...
const styles = StyleSheet.create({
    ...
    container:{width: screenWidth, height: 100, flexDirection: "row", backgroundColor: 'white'}
});
